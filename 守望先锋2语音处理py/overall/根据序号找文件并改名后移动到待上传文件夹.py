...
# 定义目录路径
zh_dir = r"G:\守望语音\ow-wuyang-ver\ZH"
en_dir = r"G:\守望语音\ow-wuyang-ver\EN"
target_dir = r"G:\守望语音\ow-wuyang-ver\待上传"
doc_path = r"G:\守望语音\ow-wuyang-ver\同步序号.txt"  # 修改为你的文档路径
